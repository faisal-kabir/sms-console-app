...
void main() {
  group('SMS Data Models JSON Parsing Tests (Prevents REVIEW.md Findings 3 & 9)', () {
    test('Should parse CostBreakdown and decimal cost string without casting exceptions', () {
    ...
    test('Should parse SmsMessage with correct fields and types', () {
      ...
      expect(message.sentAt.toUtc(), DateTime.parse('2026-07-09T08:14:22Z').toUtc());
    });
  });
}
