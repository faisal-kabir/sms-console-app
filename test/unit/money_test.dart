...
void main() {
  group('Money Arithmetic Tests (Prevents REVIEW.md Finding 2: Floating-point precision loss)', () {
    ...
    test('Should multiply money exactly without binary floating-point drift', () {
